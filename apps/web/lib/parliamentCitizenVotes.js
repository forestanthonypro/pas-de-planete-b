...
export function saveParliamentCitizenVote(country, anonymousId, voteId, position) {
  return fetch(`/api/parliament/${country}/citizen-votes`, {
    method: "POST",
...
export function fetchParliamentCitizenVotes(country, anonymousId) {
  return fetch(`/api/parliament/${country}/citizen-votes/${anonymousId}`).then((res) => {
...
export function fetchParliamentCitizenAlignment(country, anonymousId) {
  return fetch(`/api/parliament/${country}/citizen-votes/${anonymousId}/alignment`).then((res) => {
...
export function fetchParliamentCitizenVoteStats(country, voteId) {
  return fetch(`/api/parliament/${country}/votes/${voteId}/citizen-stats`).then((res) => {
...
export function deleteAllParliamentCitizenVotes(country, anonymousId) {
  return fetch(`/api/parliament/${country}/citizen-votes/${anonymousId}`, { method: "DELETE" }).then((res) => {
