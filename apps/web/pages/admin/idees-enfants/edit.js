...
function AdminFutureIdeaEditInner() {
  ...
  useEffect(() => {
    ...
    setSubmittedPublicly(Boolean(ideaData.submitted_publicly));
    setSubmitterEmail(ideaData.submitter_email || null);
    setSubmissionNotes(ideaData.submission_notes || null);
  }, [ideaData]);
