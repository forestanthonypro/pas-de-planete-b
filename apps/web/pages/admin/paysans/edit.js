...
function AdminPaysanEditInner() {
  ...
  useEffect(() => {
    ...
    setSubmissionNotes(paysanData.submission_notes || null);
    setSubmitterEmail(paysanData.submitter_email || null);
    setSubmittedPublicly(paysanData.submitted_publicly || false);
  }, [paysanData]);
