      ...
      {!loading && !error && summary && (
        <>
          ...
          <section style={{ marginTop: "2rem" }}>
            <h2 id="energie">{t("energie.mix_title")}</h2>
...
<table style={{ width: "100%", minWidth: 640, borderCollapse: "collapse", marginTop: "0.5rem" }}>
          ...
          <section style={{ marginTop: "2rem" }}>
            <h2 id="biodiversite">{t("pays.biodiversity_title")}</h2>
            {(() => {
...
<table style={{ width: "100%", minWidth: 640, borderCollapse: "collapse" }}>
      ...
      <section style={{ marginTop: "2rem" }}>
        <h2 id="incendies">{t("pays.fires_title")}</h2>
        {!loading && !error && (
          fires.length > 0 ? (
            <p>
      ...
      <section style={{ marginTop: "2rem" }}>
        <h2 id="vegetation">{t("vegetation.title")}</h2>
