...
- **Vérification de domaine Brevo** : toujours à faire sur le domaine définitif. Le blocage DNS précédemment rencontré ne devrait plus se poser avec la nouvelle configuration.
